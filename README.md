...
* **Autor Responsable:** Ing. Oscar Hernando Eraso Terán (Docente Investigador)
...
└── ui/                                        # Componentes de interfaz
    └── about_dialog.py                        # Diálogo institucional
```
...
1. Descargue o copie la carpeta `Observatorio_Forestal_UTN` en el directorio de complementos de su perfil de QGIS:
   * **Windows:**
     ```text
